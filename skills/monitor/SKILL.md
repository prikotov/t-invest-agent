...
```bash
    ...
    php scripts/monitor.php create schedule --cron="0 9 * * 1-5" --prompt="@monitoring/morning-check"

    # Еженедельный отчёт
    php scripts/monitor.php create schedule --cron="0 18 * * 5" --prompt="@monitoring/weekly-report"
```
