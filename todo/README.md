...
| 3 | Память и персонализация | ✅ DONE | MEDIUM |
...
- [x] `data/memory/user.json` с предпочтениями
- [x] Авто-обновление позиций из портфеля

### 3.3 Учёт памяти ✅

- [x] Загрузка памяти в SKILL.md
- [x] Учёт предпочтений при рекомендациях
